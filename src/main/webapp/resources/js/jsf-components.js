  ...
  var requestRows = function(all) {
    ...
    var onError = function(errorData) {
      if(!errorData)
        ...
        progressOverlay.showError(errorData);

      onUpdate('error');
    };

    var onUpdate = function(st) {
      events.trigger('update', {status:st});
    };
...
function EyelineUpdatableContentComponent(contentId, updatePeriod, errorMessage) {
  ...
  var _update = function(showOverlay, hideOverlayTimeout, submitNewValues, callback, errorCallback) {
  ...
  this.update = function(showOverlay, hideOverlayTimeout, submitNewValues, callback, errorCallback) {
    _update(showOverlay, hideOverlayTimeout, submitNewValues, callback, errorCallback);
  };
