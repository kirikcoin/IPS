...
<#-- BEGIN PATCH:
    ...
    Using template from http://htmlemailboilerplate.com/
-->
<#macro email_page_head>
<#-- END PATCH -->
...
<body>
<!-- Wrapper/Container Table: Use a wrapper table to control the width and the background color consistently of your email. Use this approach instead of setting attributes on the body tag. &ndash;&gt;
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
  <tr>
    <td>

      <!-- Tables are the most common way to format your email consistently. Set your table widths inside cells and in most cases reset cellpadding, cellspacing, and border to zero. Use nested tables as a way to space effectively in your message. &ndash;&gt;
      ...
      <!-- End example table &ndash;&gt;

      <!-- Yahoo Link color fix updated: Simply bring your link styling inline. &ndash;&gt;
